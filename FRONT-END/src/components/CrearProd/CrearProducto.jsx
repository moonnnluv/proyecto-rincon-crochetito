...
export function CrearProducto() {
  ...
  //controla los cambios provocados en los elementos del formulario
  ...
  //controlar el envio de datos del formulario 
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  required style={{ backgroundColor: 'white' }}
                />
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  required style={{ backgroundColor: 'white', color: 'black',  }}>
